...
* Copy file calendar-reminder/webapp/target/calendar-reminder-webapp.war into Platform-Tomcat/webapps
* Copy file calendar-reminder/lib/target/calendar-reminder-lib-1.0.x-SNAPSHOT.jar and calendar-reminder/config/target/calendar-reminder-config-1.0.x-SNAPSHOT.jar into Platform-Tomcat/lib
* Start tomcat.
* Note: three files above are also available in calendar-reminder/bundle/target/calendar-reminder-bundle-1.0.x-SNAPSHOT.zip
